...
public class PadiActivity extends AppCompatActivity {
    ...
    private static final String TAG = PadiActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseReference myRef = database.getReference("cabe_rawit");
        ...
        time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(PadiActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        mFirebaseInstance.getReference("cabe_rawit").child("baca_suhu").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        mFirebaseInstance.getReference("cabe_rawit").child("baca_kelembaban").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
