...
public class KentangActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseReference myRef = database.getReference("kentang");
        ...
        time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(KentangActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        mFirebaseInstance.getReference("kentang").child("baca_suhu").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        mFirebaseInstance.getReference("kentang").child("baca_kelembaban").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
