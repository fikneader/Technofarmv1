...
public class BungaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseReference myRef = database.getReference("bunga");
        ...
        setHold.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                myRef.child("set_kelembaban").push().setValue(angkalembab);
        ...
        time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(BungaActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        mFirebaseInstance.getReference("bunga").child("baca_suhu").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        mFirebaseInstance.getReference("bunga").child("baca_kelembaban").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
